...
# MiniDev-Logistic:  ms-location

La presente iniciativa contiene el codigo de un mini desarrollo de software BackEnd.
En particular, este proyecto contiene el modulo denominado ms-location.
...
In particular, this project contains the module called ms-location.
